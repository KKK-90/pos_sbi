...
class AdvancedPOSTracker {
  constructor() {
    ...
    this.importData = [];
    this.users = [
      "KARNA", "NKR", "SKR", "BGR", "SBI_DOP",
      "NKRO", "admin", "admin1", "superadmin1"
    ];
  ...
  filterLocations() {
    ...
    the status = document.getElementById("statusFilter")?.value || "";
...
window.exportToExcel    = () => tracker.exportCurrentData();    // legacy behavior
